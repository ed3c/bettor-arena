# Archived skill-authoring legacy

> `LEGACY_ARCHIVED`：以下內容逐字移自 bettor-arena commit `26dad8c1646746e1da6168257b383f171a2f0aca` 的 model-visible `SKILL.md`。它只供語意追溯，不是目前程序、runtime truth 或驗收清單；現行規則以 [`../SKILL.md`](../SKILL.md) 與其 trigger-selected modules 為準。
