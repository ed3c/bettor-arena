...
for required in AGENTS.md CLAUDE.md PROMPT.md PLAN.md ROUTES.md bun.lock eslint.config.mjs prettier.config.mjs tsconfig.json modules/architecture.md modules/exchange-formats.md modules/production-readiness.md modules/semantic-truth-context.md src/check_factory_minimum_lineage.ts src/run_fast_quality.ts src/run_generated_fast_quality.ts run.sh trigger.sh selftest.sh portability.sh; do
