...
for required in AGENTS.md CLAUDE.md PROMPT.md PLAN.md ROUTES.md trigger.sh run.sh selftest.sh portability.sh modules/eight-base-laws.md modules/exchange-formats.md schemas/ctg-input.schema.json schemas/ctg-route-result.schema.json src/code_truth_graph/verify_artifacts.py; do
  [ -f "$HERE/$required" ] || {
