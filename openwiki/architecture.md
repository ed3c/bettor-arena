...
Every tracked root-level item must map to a slot in the §2 fenced tree (src: ARCHITECTURE.md:12-39). No slot = amend the map first, then land the file; each amendment rides a human-admitted commit (src: ARCHITECTURE.md:12).
