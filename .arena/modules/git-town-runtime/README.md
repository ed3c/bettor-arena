# `git-town-runtime` module

`git-town-runtime` owns [`../../../scripts/git-town/`](../../../scripts/git-town/) and [`../../../.github-delivery/git-town/`](../../../.github-delivery/git-town/), with the full narrative in [`../../../docs/git/runtime/GIT_TOWN_RUNTIME.md`](../../../docs/git/runtime/GIT_TOWN_RUNTIME.md).

## Capabilities

```text
loopx.git-town-runtime/v1
```
