...
| [`loopx-kernel`](loopx-kernel/) | Objective/Todos/Gates/Evidence/Quota contract and authority boundary; terminal leaf, not composition-selected |
| [`loopx-ledger`](loopx-ledger/) | Append-only POSIX event ledger and deterministic reducer; true child of `loopx-kernel`, not composition-selected |
