...
| [`loopx-worker-gateway`](loopx-worker-gateway/) | host registry → bounded Worker execution → observable event/receipt | `loopx.worker-gateway/v1`; terminal leaf, not composition-selected |
